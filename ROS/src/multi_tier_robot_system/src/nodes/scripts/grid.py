...
class Grid(object):
    ...
    def _ping(self, sonar):
        if sonar.data:
            x =  sonar.global_pos[0] + sonar.data * math.sin(sonar.global_angle)
            y = sonar.global_pos[1] + sonar.data * math.cos(sonar.global_angle)
        ...
        for d in range(sonar.data):
            x = sonar.global_pos[0] + d * math.sin(sonar.global_angle)
            y = sonar.global_pos[1] + d * math.cos(sonar.global_angle)
